...
const CHECKPOINT_TEST_SCRIPTS = [
  ...
  'runtime-limits-repository-contract-test.js',
  ...
  'run-phase-repository-contract-test.js',
  'run-recovery-repository-contract-test.js',
  'run-terminalization-repository-contract-test.js',
  'reconciliation-flow-test.js',
  'verification-contract-reconciliation-test.js',
  'ticket-run-lifecycle-repository-contract-test.js',
  'run-replay-repository-contract-test.js',
  'runtime-state-read-repository-contract-test.js',
  'runtime-bootstrap-repository-contract-test.js',
  'triage-repository-contract-test.js',
  'operational-status-repository-contract-test.js',
  'diagnostic-log-repository-contract-test.js',
  'performance-analytics-repository-contract-test.js',
  'work-context-repository-contract-test.js',
  'non-terminal-evidence-repository-contract-test.js',
  'configured-agent-repository-contract-test.js',
  'access-catalog-repository-contract-test.js',
  'workflow-catalog-repository-contract-test.js',
  'model-routing-policy-repository-contract-test.js',
  'connector-authority-repository-contract-test.js',
  'watcher-authority-repository-contract-test.js',
  'process-template-projection-repository-contract-test.js',
  'process-template-authority-repository-contract-test.js',
  'workspace-ownership-repository-contract-test.js',
  'operator-recovery-repository-contract-test.js',
