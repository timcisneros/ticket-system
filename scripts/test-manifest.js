...
const TESTS = Object.freeze([
  ...
  { file: "t3-objective-revision-contract-test.js", status: "required" },
  ...
  { file: "declared-completion-authority-binding-test.js", status: "required" },
  ...
  { file: "max-attempts-finalization-race-test.js", status: "required" },
  ...
  { file: "execution-target-registry-test.js", status: "required" },
  { file: "economic-accounting-schema-postgres-test.js", status: "required" },
  { file: "economic-accounting-store-postgres-test.js", status: "required" },
  { file: "governed-leaf-authority-postgres-test.js", status: "required" },
  ...
  { file: "governed-verified-progress-credit-postgres-test.js", status: "required" },
  { file: "postcondition-criterion-evaluator-test.js", status: "required" },
  { file: "governed-eligible-facts-test.js", status: "required" },
  { file: "governed-fact-transitions-test.js", status: "required" },
  { file: "agent-run-draft-test.js", status: "required" },
  { file: "test-server-startup-contract-test.js", status: "required" },
  { file: "governed-openai-transport-hermetic-test.js", status: "required" },
  ...
  { file: "governed-blocked-restart-postgres-test.js", status: "required" },
  ...
  { file: "structured-allocation-evaluation-runner-postgres-test.js", status: "required" },
  ...
  { file: "evaluation-live-production-closure-test.js", status: "required" },
  ...
  { file: "evaluation-zero-drift-barrier-postgres-test.js", status: "required" },
  ...
  { file: "evaluation-live-observation-projection-test.js", status: "required" },
  { file: "provider-transport-observation-test.js", status: "required" },
  ...
  { file: "provider-transport-invocation-postgres-test.js", status: "required" },
  { file: "ungoverned-real-envelope-pipeline-postgres-test.js", status: "required" },
  ...
  { file: "provider-adapter-capability-test.js", status: "required" },
  { file: "role-routing-contract-test.js", status: "required" },
  ...
  { file: "structured-allocation-prerequisites-postgres-test.js", status: "required" },
  ...
  { file: "typed-evidence-projection-test.js", status: "required" },
  { file: "typed-projection-parity-postgres-test.js", status: "required" },
