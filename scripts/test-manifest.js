...
const TESTS = Object.freeze([
  ...
  { file: "er1-readfile-recoverable-test.js", status: "orphaned", reason: "cutover-orphan" },
  { file: "er2-createfolder-existing-file-recoverable-test.js", status: "orphaned", reason: "cutover-orphan" },
  { file: "er2a-readfile-notafile-recoverable-test.js", status: "orphaned", reason: "cutover-orphan" },
  { file: "er2b-writefile-notafile-recoverable-test.js", status: "orphaned", reason: "cutover-orphan" },
  { file: "er2c-listdirectory-not-enoent-recoverable-test.js", status: "orphaned", reason: "cutover-orphan" },
  ...
  { file: "event-journal-admission-recovery-test.js", status: "orphaned", reason: "cutover-orphan" },
  { file: "event-journal-record-rejection-test.js", status: "orphaned", reason: "cutover-orphan" },
  ...
  { file: "invalid-action-preflight-recovery-test.js", status: "orphaned", reason: "cutover-orphan" },
  ...
  { file: "manual-rerun-attempt-ceiling-test.js", status: "orphaned", reason: "cutover-orphan" },
  { file: "max-attempts-control-test.js", status: "orphaned", reason: "cutover-orphan" },
  ...
  { file: "rbac-and-inline-data-security-test.js", status: "orphaned", reason: "cutover-orphan" },
  ...
  { file: "tm2-evidence-preservation-test.js", status: "orphaned", reason: "cutover-orphan" },
