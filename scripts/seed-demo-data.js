...
function seed() {
  ...
  writeJson('tickets.json', [
    ...
    ticket(5, 'completed', 'Reconcile billing exports (attempt ceiling: maxAttempts 2)', { executionPolicy: { maxAttempts: 2 } }),
  ...
  writeJson('logs.json', [
    { id: 1, timestamp: T0, runId: null, ticketId: null, agentId: null, agentName: 'System', type: 'ticket:max_attempts_change', message: 'Ticket #5 maxAttempts changed from runtime default to 2 by admin', workspaceAction: null, contextTicketId: 5, changedBy: 'admin', fromMaxAttempts: null, toMaxAttempts: 2 },
