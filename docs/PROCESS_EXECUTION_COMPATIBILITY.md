...
| --- | --- | --- | --- | --- |
| PostgreSQL schema | 031 | none | older schema | future or partial schema |
...
| Process operation record | schema 029 | terminal records retained under schema 031 | schema below 031 | future/unknown migrations |
...
supports schema 031. Otherwise rollback means an explicit database and paired
